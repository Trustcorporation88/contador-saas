...
export const serviceCatalog: ServiceDefinition[] = [
  ...
  },
  {
    ...
    status: "hibrido",
    summary:
      "Catalogo educacional (Contabilidade Teorica) com skills e KPIs FP&A (Margem Bruta, Margem EBITDA, Margem FCL).",
    howItWorks:
    ...
    notes: [
      "Menu: Contabilidade Teorica > Indicadores e Skills.",
