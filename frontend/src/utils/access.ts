...
const SETTINGS_ACCESS: UserRole[] = [
  "admin",
  "accountant",
  "manager",
  "auditor",
...
export function canAccessPath(
  ...
  if (path === "/servicos" || path.startsWith("/servicos/"))
    return SETTINGS_ACCESS.includes(role);
  ...
  if (path.startsWith("/relatorios/") || path === "/indicadores") return REPORT_ACCESS.includes(role);
