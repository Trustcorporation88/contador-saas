...
export class ContasPagarController {
  ...
  static async obter(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res.status(500).json({ success: false, message: 'Erro ao obter conta a pagar' });
    }
  }
  ...
  static async atualizar(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res.status(500).json({ success: false, message: 'Erro ao atualizar conta a pagar' });
    }
  }
  ...
  static async cancelar(req: Request, res: Response): Promise<Response> {
    try {
      ...
      return res.status(500).json({ success: false, message: 'Erro ao cancelar conta a pagar' });
    }
  }
